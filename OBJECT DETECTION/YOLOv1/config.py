...
parser.add_argument('--train_label_data_path', type=str, default='data/train_labels/', help='GT image path')
parser.add_argument('--train_csv_annotations', type=str, default='data/annotations.csv', help='GT image path')
# add paths for validation and test dataset
...
parser.add_argument('--test_batch_size', type=int, default=1, help='Validation batch size')
...
parser.add_argument('--load_model_file', type=str, default='yolov1.pth.tar', help='Load trained model file')
